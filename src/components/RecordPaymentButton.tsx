...
export default function RecordPaymentButton({ invoiceId, customerId, balance, currencyCode }: { invoiceId: string; customerId: string; balance: number; currencyCode: string }) {
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <form onSubmit={submit} className="p-4 space-y-3">
              ...
              <div>
                ...
                <input value={form.reference} onChange={(e) => setForm({ ...form, reference: e.target.value })} className="input" placeholder="Check #, transaction ID..." />
              </div>
